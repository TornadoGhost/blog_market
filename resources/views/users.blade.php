                                    ...
                                    <div id="DataTables_Table_0_wrapper"
                                        ...
                                        <div class="dataTables_scroll">
                                            ...
                                            <div class="dataTables_scrollBody"
                                                ...
                                                <table
                                                    ...
                                                    <tr data-entry-id="1" role="row" class="odd">
                                                        @foreach($users as $user)
                                                            @if($user->isNotBanned() && $user->is_author || $user->is_admin  )
                                                                <form action="{{ route('users.ban') }}" method="post">
                                                                    @csrf
                                                                    <td style="width: 40em;">
                                                                        {{ $user->id }}
                                                                    ...
                                                                    @elseif($user->is_author && $user->isNotBanned())
                                                                        <td>
                                                                            <span class="badge badge-info">Author</span>
                                                                        </td>
                                                                    @endif
                                                                    <td>
                                                                        <label for="date">Ban to:</label>

                                                                        <input type="datetime" type="datetime-local" id="date" name="date"
                                                                               value="{{ now() }}" min="{{ now() }}">
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <button class="btn btn-xs btn-danger">Ban
                                                                        </button>
                                                                    </td>
                                                                </form>
                                                    </tr>
                                                ...
                                                <form action="{{ route('usersBan.update') }}"
                                                      method="post" >
                                                    @csrf
                                                    <td>
                                                        <button class="btn btn-xs btn-info" >Update data
                                                        </button>
                                                    </td>
                                                </form>
                                            </div>
